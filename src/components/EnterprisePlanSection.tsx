...
const EnterprisePlanSection = () => {
  ...
  const enterpriseFeatures = ['असीमित शब्द प्रसंस्करण', 'कस्टम API एकीकरण', 'प्राथमिकता सहायता (24/7)', 'टीम प्रबंधन डैशबोर्ड', 'कस्टम ब्रांडिंग', 'एडवांस रिपोर्टिंग', 'समर्पित खाता प्रबंधक', 'ऑन-प्रिमाइसेस डिप्लॉयमेंट', 'कस्टम भाषा मॉडल', 'एसएसओ (Single Sign-On)'];
  return <div className="mt-16">
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold text-gray-800 mb-4">एंटरप्राइज़ समाधान</h2>
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">बड़े संगठनों के लिये कस्टमाइज़्ड समाधान</p>
      </div>
      ...
      <Card className="max-w-4xl mx-auto border-2 border-purple-200 shadow-xl bg-gradient-to-br from-purple-50 to-blue-50">
        <CardHeader className="text-center relative overflow-hidden">
          <div className="absolute top-0 left-0 right-0 bg-gradient-to-r from-purple-600 to-blue-600 text-white text-center py-2 text-sm font-medium">बड़े व्यवसायों के लिये</div>
          
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-r from-purple-600 to-blue-600 text-white mb-4 mx-auto mt-8 py-[14px]">
        ...
        <CardContent className="space-y-6">
          {/* Features Grid */}
          <div className="grid md:grid-cols-2 gap-3 px-0 my-[6px] mx-[62px]">
            {enterpriseFeatures.map((feature, index) => <div key={index} className="flex items-center space-x-3">
          ...
          {/* Contact Button */}
          <div className="pt-4">
            <Button onClick={handleContactClick} className="w-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white font-medium py-3 transition-all duration-300 text-lg">
                ...
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                    <div className="grid md:grid-cols-2 gap-4">
                      <FormField control={form.control} name="company_name" rules={{
                    ...
                    field
                      ...
                      <FormField control={form.control} name="contact_person" rules={{
                    required: 'संपर्क व्यक्ति का नाम आवश्यक है'
                  }} render={({
                    field
                  }) => <FormItem>
                            <FormLabel className="flex items-center space-x-2">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <FormField control={form.control} name="company_size" render={({
                    field
                  }) => <FormItem>
                    ...
                    <FormField control={form.control} name="estimated_users" render={({
                  field
                }) => <FormItem>
                  ...
                  field
                          ...
                          <FormControl>
                            <Textarea placeholder="कोई अन्य जानकारी या प्रश्न..." className="min-h-[80px]" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>} />
