...
import { Github, Mail, Heart, Facebook, Instagram, Linkedin, Hash, X } from "lucide-react";
...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { icon: Hash, href: "https://discord.com/channels/1401251646717038734/1401251648701075538", label: "Discord", hoverColor: "hover:text-indigo-400" },
