      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex justify-between text-xs text-gray-500">
            <span>{stats.corrections_this_month} सुधार किये</span>
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center space-x-1 text-xs text-gray-500">
            ...
            <span>बेहतर परिणामों के लिये लंबे टेक्स्ट का उपयोग करें</span>
          </div>
        </div>
        ...
        {isHighUsage && (
          <div className="p-3 bg-orange-50 border border-orange-200 rounded-lg">
            ...
            <p className="text-xs text-orange-700 mb-2">
              आप इस माह अधिक शब्दों का उपयोग कर रहे हैं। अधिक शब्द खरीदने पर विचार करें।
            </p>
            <Link to="/pricing">
        ...
        {!isHighUsage && balance.total_words_available > 500 && (
          <div className="p-3 bg-green-50 border border-green-200 rounded-lg">
            <p className="text-sm text-green-800 flex items-center">
              ...
              सब कुछ बढ़िया है! आपका शब्द उपयोग संतुलित है।
            </p>
          </div>
        )}
      </CardContent>
