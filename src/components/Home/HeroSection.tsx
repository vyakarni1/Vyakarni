  ...
  return (
    <section className="container mx-auto px-6 py-20 text-center relative min-h-screen flex items-center">
      ...
      <div className="relative z-10 w-full">
        ...
        <h1 className="text-6xl font-bold mb-6 bg-gradient-blue-ocean bg-clip-text text-transparent animate-fade-in leading-tight" data-translate>
          AI के साथ हिंदी लेखन
          <br />
          <span className="text-6xl">सुधारें</span>
        </h1>
        
        <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed animate-fade-in delay-75" data-translate>
        ...
        <div className="flex justify-center space-x-4 mb-8">
          <div className="flex items-center space-x-2 bg-white/70 backdrop-blur-sm rounded-full px-4 py-2 shadow-sm">
            ...
            <span className="text-sm text-gray-600" data-translate>निःशुल्क परीक्षण</span>
          </div>
          <div className="flex items-center space-x-2 bg-white/70 backdrop-blur-sm rounded-full px-4 py-2 shadow-sm">
            <CheckCircle className="h-4 w-4 text-blue-500" />
            <span className="text-sm text-gray-600" data-translate>त्वरित परिणाम</span>
          </div>
        </div>
        ...
        <Link to="/register">
          <Button size="lg" className="text-lg px-8 py-4 bg-gradient-blue-ocean hover:bg-gradient-blue-deep transform hover:scale-105 transition-all duration-300 shadow-xl group">
            <span data-translate>तत्काल आरम्भ करें</span>
