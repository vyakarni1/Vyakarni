...
const WordCreditsOverview = () => {
  ...
  const freeWordsPercentage = balance.total_words_available > 0 
    ? (balance.free_words / balance.total_words_available) * 100 
    : 0;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">फ्री शब्द</CardTitle>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">खरीदे गए शब्द</CardTitle>
