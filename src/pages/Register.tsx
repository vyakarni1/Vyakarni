...
const Register = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("रजिस्ट्रेशन सफल! कृपया अपना ईमेल चेक करें और सत्यापन लिंक पर क्लिक करें। स्पैम भी चेक करें। ईमेल सत्यापन के बाद आपको स्वागत ईमेल प्राप्त होगा।");
      navigate("/login");
    } catch (error) {
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input 
                  ...
                  required 
                  minLength={6} 
                  className="transition-all duration-200 focus:scale-105 border-gray-300 focus:border-blue-500 pr-10" 
                />
                <button
                  type="button"
