...
const Go = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-50">
      <Helmet>
        <title>Hindi Grammar Checker - व्याकरणी | AI Powered Hindi Writing Tool</title>
        <meta name="description" content="Improve your Hindi writing with AI-powered grammar checker. Instant corrections for Hindi text, grammar, and punctuation errors." />
      ...
      <div className="w-full bg-primary py-4 px-4">
        <div className="container mx-auto">
          <div className="flex justify-center">
            ...
            >
              <a href="https://vyakarni.com/register" className="font-semibold">
