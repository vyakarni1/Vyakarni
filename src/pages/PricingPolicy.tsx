    ...
    content: (
      <div className="space-y-8">
        ...
        <section>
          ...
          <p className="text-gray-600 leading-relaxed">
            हम क्रेडिट कार्ड, डेबिट कार्ड, UPI, नेट बैंकिंग और डिजिटल वॉलेट सहित विभिन्न भुगतान विधियों को स्वीकार करते हैं। सभी भुगतान हमारे विश्वसनीय भुगतान साझेदारों के माध्यम से सुरक्षित रूप से संसाधित किये जाते हैं।
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-600 leading-relaxed">
            सभी लागू कर (GST सहित) की गणना की जाती है और चेकआउट पर सब्सक्रिप्शन लागत में जोड़े जाते हैं। भुगतान पुष्टि से पहले अंतिम देय राशि स्पष्ट रूप से प्रदर्शित की जायेगी।
          </p>
        </section>

        <section>
          <h2 className="text-2xl font-bold mb-4">6. रिफंड और निरस्तीकरण</h2>
          <p className="text-gray-600 leading-relaxed">
            रिफंड अनुरोधों को हमारी रिफंड नीति के अनुसार संभाला जाता है। सब्सक्रिप्शन को किसी भी समय निरस्त किया जा सकता है, किन्तु वर्तमान बिलिंग अवधि के अंत तक सेवायें जारी रहती है।
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            बिलिंग पूछताछ या मूल्य निर्धारण प्रश्नों के लिये, कृपया संपर्क करें:
          </p>
